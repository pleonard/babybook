...
*/
    ...
    _avieImageMay.image = [UIImage imageNamed:@"may_bath.jpg"];
    _avieImageJune.image = [UIImage imageNamed:@"june_dillon_large.jpg"];
    _avieImageJuly.image = [UIImage imageNamed:@"jul_hiking_large.jpg"];
    _avieImageAugust.image = [UIImage imageNamed:@"aug_hair_large.jpg"];
    _avieImageSeptember.image = [UIImage imageNamed:@"sep_laugh_yard.jpg"];
    _avieImageOctober.image = [UIImage imageNamed:@"oct_lobster_large.jpg"];
    ...
    _avieImages = @[@"avie_burrito.jpg", @"apr_feeding.jpg", @"may_bath.jpg", @"june_dillon_large.jpg", @"jul_hiking_large.jpg", @"aug_hair_large.jpg", @"sep_laugh_yard.jpg", @"oct_lobster_large.jpg", @"nov_bath_mohawk.jpg"
    ];
    _avieDescriptions = @[
        @"After a long day of Mommy working very, very, hard, our little Avery was born on a snowy day the 1st of March 2012. When she rolled over after only 2 weeks we knew she would be a ""spirited"" little girl!",
        ...
        @"We learned quickly that Avie loves being outside - she's definitely a Colorado girl. We went to Dillon with Noni and Papaw and looked up at the trees and clouds.",
