...
- (void)viewDidLoad
{
    ...
    _avieDescriptions = @[
        ...
        @"We got the ""Bob"" stroller for a reason - to take off road! So here is Mommy and Avid on the Tenderfoot trail near the condo in Dillon. She doesn't like being in the stroller, but is perfectly happy with it if she's on a hike in the mountains.",
